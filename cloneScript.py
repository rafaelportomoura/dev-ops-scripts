...
def getFilePath(_file_path_, _ = "\\"):
  pwd = os.path.realpath(os.getcwd())

  return f'..{_}CodeCommit{_}{_file_path_}'
def clone(repository, path,_ = "\\"):
  os.system(f'git clone codecommit://{profile}@{repository} {path}{_}{repository}')
